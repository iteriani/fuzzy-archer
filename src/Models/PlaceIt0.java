...
public class PlaceIt0 {
	...
	public PlaceIt0(int id, String title, String description, double latitude,
	...
	public PlaceIt0(String title, String description, double latitude,
			double longitude, long date) {
		this._title = title;
		this._description = description;
		this._latitude = latitude;
	...
	// constructor
	public PlaceIt0(String title, String description) {
		this._title = title;
		this._description = description;
	}
